...
import { Menu, Search, Users, Plus, Edit, Trash, X, LogOut, Home, Package, FileText } from 'lucide-react';
          ...
          <div className="p-6 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-right">
                <p className="font-semibold text-[#1A6291]">Admin RajaPharma</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200">
                  ...
                  {filteredUsers.map((user, index) => (
                    <tr key={user.id} className={`hover:bg-gray-50 transition-colors ${index % 2 === 0 ? 'bg-white' : 'bg-gray-25'}`}>
                      <td className="px-6 py-4">
                        <span className="font-semibold text-[#1A6291]">#{user.id.toString().padStart(3, '0')}</span>
                      </td>
                      <td className="px-6 py-4">
            ...
            {filteredUsers.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-700 mb-2">Tidak ada pengguna ditemukan</h3>
                <p className="text-gray-500">Coba ubah kata kunci pencarian atau tambah pengguna baru</p>
              </div>
            )}
          </div>
        </div>
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">
                      {userForm.id ? 'Perbarui informasi pengguna' : 'Masukkan data pengguna baru'}
                    </p>
                  </div>
                  <button 
